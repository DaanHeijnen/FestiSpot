const { json, preflight, parseBody, sha256, getValidSession, tokenForSession } = require('./_shared');
...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (!sessionId || !passcode) return json(400, { ok: false, error: 'Missing sessionId or passcode' });
